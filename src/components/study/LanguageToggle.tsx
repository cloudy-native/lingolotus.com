    ...
    return (
        <Flex justify="center">
            <HStack spacing={4}>
                ...
                <Button
                    colorScheme={
                        cardFrontLanguage === "target" ? "primary" : "gray"
                    }
                    variant={
                        cardFrontLanguage === "target" ? "solid" : "outline"
                    }
                    onClick={() => setCardFrontLanguage("target")}
                    boxShadow={
                        cardFrontLanguage === "target"
                            ? "0 0 0 2px #3182ce"
                            : undefined
                    }
                    borderWidth={2}
                    borderColor={
                        cardFrontLanguage === "target" ? "blue.400" : "gray.200"
                    }
                ...
                <Button
                    colorScheme={
                        cardFrontLanguage === "source" ? "primary" : "gray"
                    }
                    variant={
                        cardFrontLanguage === "source" ? "solid" : "outline"
                    }
                    ...
                    borderWidth={2}
                    borderColor={
                        cardFrontLanguage === "source" ? "blue.400" : "gray.200"
                    }
                    _hover={{ transform: "scale(1.05)", boxShadow: "md" }}
